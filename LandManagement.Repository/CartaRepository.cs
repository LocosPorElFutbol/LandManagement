...
{
    public class CartaRepository : BaseRepository<tbcarta>
    {
        ...
        public override void Create(tbcarta entity)
        {
        ...
        public override void Delete(tbcarta entity)
        {
            throw new NotImplementedException();
        }
        ...
        public override object GetList(Func<tbcarta, bool> funcion)
        {
            throw new NotImplementedException();
        }
    }
