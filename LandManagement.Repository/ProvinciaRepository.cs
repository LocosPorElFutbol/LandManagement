...
{
    public class ProvinciaRepository : BaseRepository<tbprovincia>
    {
        ...
        public override void Create(tbprovincia entity)
        {
            throw new NotImplementedException();
        }

        public override void Update(tbprovincia entity)
        {
            throw new NotImplementedException();
        }

        public override void Delete(tbprovincia entity)
        {
            throw new NotImplementedException();
        }
