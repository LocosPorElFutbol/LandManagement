...
namespace LandManagement.Utilidades
{
    public class BuscarEnDataGridView
    {
        ...
        public DataGridView FiltrarDataGridView(DataGridView _dgv, string _valorBusqueda)
        {
            return this.FiltrarDataGridView(_dgv, new List<string>(), _valorBusqueda);
        }
        ...
        /// <returns>DataGridView filtrado</returns>
        public DataGridView FiltrarDataGridView(DataGridView _dgv, List<string> _omitirColumnas, string _valorBusqueda)
        {
        ...
        private List<DataGridViewRow> AplicarFiltroDataGridView(DataGridView _dgv, List<string> omitirColumnas, string valorBusqueda)
        {
