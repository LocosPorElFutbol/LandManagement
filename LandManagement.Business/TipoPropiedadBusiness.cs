...
namespace LandManagement.Business
{
    public class TipoPropiedadBusiness
    {
        ...
        {
            this._TipoPropiedadRepository = new TipoPropiedadRepository();
            menuBusiness = new MenuBusiness();
        }

        public void Create(tbtipopropiedad tbtipopropiedad)
        {
            _TipoPropiedadRepository.Create(tbtipopropiedad);
        }

        public void Update(tbtipopropiedad tbtipopropiedad)
        {
            _TipoPropiedadRepository.Update(tbtipopropiedad);
        }

        public void Delete(tbtipopropiedad tbtipopropiedad)
        {
            _TipoPropiedadRepository.Delete(tbtipopropiedad);
        }

        public object GetElement(tbtipopropiedad tbtipopropiedad)
        {
            return _TipoPropiedadRepository.GetElement(tbtipopropiedad);
        }
        ...
        {
            return _TipoPropiedadRepository.GetList();
        }
        /*
