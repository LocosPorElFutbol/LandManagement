...
namespace LandManagement.Business
{
   public class ServiciosBusiness
    {
                private ServiciosRepository _ServiciosRepository;
           private MenuBusiness menuBusiness;
        public ServiciosBusiness()
        {
            this._ServiciosRepository = new ServiciosRepository();
            menuBusiness = new MenuBusiness();
        }

        public void Create(tbservicios tbservicio)
        {
            _ServiciosRepository.Create(tbservicio);
        }

        public void Update(tbservicios tbservicio)
        {
            _ServiciosRepository.Update(tbservicio);
        }

        public void Delete(tbservicios tbservicio)
        {
            _ServiciosRepository.Delete(tbservicio);
        }

        public object GetElement(tbservicios tbservicio)
        {
            return _ServiciosRepository.GetElement(tbservicio);
        }
        ...
        {
            return _ServiciosRepository.GetList();
        }
        /*
